...
const PrivacyPolicy = () => (
    <div className="prose prose-sm dark:prose-invert">
        ...
        <h3>Data supply and consequences in the event of failure to consent to processing. Legal basis. Storage period of personal data</h3>
        ...
        <h3>Scope of data communication</h3>
        ...
        <h3>Updating of the privacy policy</h3>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-4 font-body">
        <Card className="w-full max-w-sm bg-card/80 backdrop-blur-sm border-white/20 text-black">
            ...
            <form onSubmit={handleLogin}>
                ...
                <CardFooter>
                <Button className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-bold" type="submit" disabled={isLoading}>
